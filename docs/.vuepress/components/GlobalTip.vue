...
function addTip(content, type, startHeight = 50, dieTime = 3000) {
  ...
  if (type == "info" || type == 1) {
    div.innerHTML = `<i class="iconfont icon-info-circle-fill icon"></i><p class="tip-info-content">${content}</p>`;
  } else if (type == "success" || type == 2) {
    div.innerHTML = `<i class="iconfont icon-success-filling icon"></i><p class="tip-success-content">${content}</p>`;
  } else if (type == "danger" || type == 3) {
    div.innerHTML = `<i class="iconfont icon-error icon"></i><p class="tip-danger-content">${content}</p>`;
  } else if (type == "warning" || type == 4) {
    div.innerHTML = `<i class="iconfont icon-warning-fill icon"></i><p class="tip-warning-content">${content}</p>`;
  }
